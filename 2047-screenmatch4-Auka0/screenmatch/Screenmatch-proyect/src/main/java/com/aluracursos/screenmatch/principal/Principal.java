...
public class Principal {
    ...
    private final String API_KEY = "&apikey=13cc7bba";
...
//        temporadas.forEach(t -> t.episodios().forEach(e -> System.out.println(e.titulo())));
        ...
        //Convertir toda la informacion en una lista tipo DatosEpisodio
...
//        System.out.println("Por favor indica la fecha a partir del cual deseas ver un episodio");
